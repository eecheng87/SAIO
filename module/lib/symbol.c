...
void* (*copy_process_ptr)(void*, int, int, void*) = 0;
int (*kernel_clone_ptr)(void*) = 0;
...
void init_not_exported_symbol()
{
    ...
    copy_process_ptr = (void* (*)(void*, int, int, void*))(
        copy_process_base + ((char*)&system_wq - sysWQ));
    kernel_clone_ptr = (int (*)(void*))(kernel_clone_base + ((char*)&system_wq - sysWQ));
}
